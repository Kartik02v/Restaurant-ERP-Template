...
export const metadata: Metadata = {
  title: "Gourmet Restaurant - Experience Culinary Excellence",
  description:
    "Crafted with passion, served with pride. Discover a world of flavors where every dish tells a story.",
};
